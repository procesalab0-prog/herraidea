...
- La imagen queda sincronizada con el modelo 3D publicado en la versión anterior y utiliza una ruta nueva para evitar la caché de la portada provisional.
...
- Easter egg de seis toques en el logotipo de Herraidea.
- Panel de créditos y versiones “Creado por ProcesaLab”.
- Sistema persistente de versión y contexto para colaboradores y agentes.

## 1.7.0 — 2026-08-29

- Transición del hero de día a noche controlada por scroll.
- Imagen nocturna alineada exactamente con la escena diurna.

## 1.6.0 — 2026-08-29

- Recorrido técnico 3D inmersivo en computadora y teléfono.
- Etiquetas técnicas, progreso 01/03 y resúmenes dinámicos.

## 1.5.0 — 2026-08-29

- Fichas técnicas animadas para los 66 productos.
- 159 fotografías, variantes y planos técnicos migrados desde Jimdo.
- Historia, misión, visión y valores estructurados.

## 1.4.0 — 2026-08-29

- PWA instalable, iconos de inicio y tarjeta social para WhatsApp.

## 1.3.0 — 2026-08-29

- Landing completa, catálogo, contacto y experiencia móvil.

## 1.2.0 — 2026-08-29

- Hero animado y despliegue inicial en Vercel.

## 1.1.0 — 2026-08-29

- Migración del catálogo, contenido e imágenes públicas de Jimdo.

## 1.0.0 — 2026-08-29

- Inicialización del repositorio Herraidea.
