...
- `assets/projects/hrd-1616/`: modelo GLB de esquina y portada oficial del sistema de poste cuadrado con cable de acero; `portada-estudio-final.png` evita reutilizar la portada anterior almacenada en caché y muestra la composición completa.
